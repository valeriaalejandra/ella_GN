 ...
 **Historia**
   ...
   Sus papas llegan a casa, la buscan, pero no hay algún rastro de ella, solo una carta que dice “fui a comprar un café” … La intentan llamar, pero dejo el celular en su casa, ellos toman la decisión de esperarla, pero nunca llego.
...
**22:00** Una habitación desolada, una familia desesperada y una casa invadida de pánico entrando por cada una de las ventanas. 

**22:22** Desubicados y con ansias infinitas de tener una respuesta se inicia la búsqueda.

**22:40** Llamadas y mensajes salientes sin respuesta alguna, se seguía sin saber que había sucedido.

**23:50** El hermano de ella recibe una llamada de un número desconocido, no alcanza a contestar y en seguida un mensaje llega a su celular, el cual para él no tenía nada de lógica, solo se le hizo muy extraño.

 *El primer término de una progresión aritmética es –1, y el decimoquinto es 27. La suma de los quince primeros términos, es el número que dice el mensaje de texto*
   
**Respuesta Correcta:** 195

**Respuesta Incorrecta:** 2

**Explicación:** Al aplicar la fórmula de progresiones aritmetica  27 = −1 + (15 − 1)d  de donde se obtiene la diferencia común d= 2 para reemplazarlo y obtener la suma de términos   S = (−1 + 27) 15/2 = 195.

**Autores:**  Angela Castro, Valentina Restrepo y Valeria Rodriguez

*************************************************************************************

**Historia**

Al contestar de forma incorrecta la primera contribución...

7:45 suena el teléfono timbran 1, 2, 4, 5, 10, 11, 20, 22, 44,… 55 van 110 veces y nada ; al
parecer nadie está en casa pistas, hullas, no hay nada pero un ambiente de zozobra en un
pueblo de 2800 habitantes ¿Qué está pasando?

**Problema**

Para continuar con el desarrollo de la historia tendrás que hallar el número amigo con el
número de habitantes pero la omisión de un cero es necesaria, ojo tu pista está en la cantidad
de veces que se timbran…. Este resultado es la cantidad de personas que han desaparecido en
los últimos 20 años.
...
Tu pista son las veces en las que timbran los cuales son los divisores de 210 que la sumarlos
(1+ 2 + 4 + 5+ 10 + 11 + 20 + 22 + 44 + 55 + 110 = 280) den la cantidad de habitantes
