...
Continuacion:  Correcto-Correcto

Ella despierta somnolienta.El frío de la superficie le pome la piel de gallina.Todo está en medio de la penumbra, un aura verdos sube por el ambiente.Hay una figura parada en medio del austero lugar.La anciana no vacila en levantarla de una patada,haciéndola chillar.Suplica su libertad.Ella está confundida.La anciana,en medio de una sencilla risa,le comunica que falta mucho para que todo acabe.Ella es parte de algo mas grande.

## Problema

Calcular un número X de modo que sumar 5 al doble de X tiene el mismo resultado que restar 1 al triple dde X.
...
El doble de x es 2x. Le sumamos 5

2x+5

El triple de x es 3x.Le restamos 1

3x-1

Los dos numeros anteriores tienen que ser iguales:
